# Question Timer
The `question timer` component will render a nice timer animation for questions.
...
## Adjustments
If you want to modify this component follow the instructions below. However, there are no configurable options in the file.
...
3. Add the timer sound which you can find HERE (TODO)
